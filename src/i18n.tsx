...
const ko: Record<string, string> = {
        ...
        "Select a source image and create a profile for this computer first.": "원본 이미지를 선택하고 이 컴퓨터의 프로필을 먼저 만드세요.", "Next steps": "다음 단계",
        "Prepare the package here. Use the vendor tool for flashing and the firmware screen for setup values.": "여기에서 패키지를 준비하세요. 플래시는 제조사 도구에서 진행하고 설정값은 펌웨어 화면에서 바꾸세요.",
        ...
        "FLASH WITH VENDOR TOOL": "제조사 도구에서 플래시", "Use the prepared image": "준비된 이미지 사용", "Dismiss operation status": "작업 상태 닫기", "Source image and recovery files": "원본 이미지 및 복구 파일",
